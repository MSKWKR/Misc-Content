...
#>
# Set-GPRegistryValue -Name EndpointRecommendedSettings -Key "HKLM\Software\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\ASR\Rules" -ValueName "56a863a9-875e-4185-98a7-b882c64b5ce5" -Type DWord -Value $mode
